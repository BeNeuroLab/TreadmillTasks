...
motionSensor = MotionDetector_2ch(name='MotSen1', event='motion',
                                  calib_coef=1, threshold=1, sampling_rate=100,
                                  reset=board.port_4.DIO_A,
                                  sensor1pins={'CS': board.port_3.DIO_A, 'MI': board.port_1.DIO_A, 'MO': board.port_1.DIO_B, 'SCK': board.port_2.DIO_C},
                                  sensor2pins={'CS': board.port_4.DIO_B, 'MI': board.port_4.DIO_C, 'MO': board.port_5.DIO_A, 'SCK': board.port_5.DIO_B})
