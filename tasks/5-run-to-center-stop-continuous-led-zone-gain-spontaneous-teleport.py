"""Recording variant with spontaneous phases and teleport perturbations."""
...
# teleport blocks containing 70% control, 15% forward, and 15% backward
# trials. Teleports trigger at 35-50% of the visual track and shift the
# cursor by 15% without changing measured physical distance.
...
def configure_teleport_trial():
    ...
    elif v.task_phase_number <= v.teleport_warmup_task_phases:
        v.teleport_trial_type = 'control'
        v.teleport_session_phase = 'warmup'
    else:
